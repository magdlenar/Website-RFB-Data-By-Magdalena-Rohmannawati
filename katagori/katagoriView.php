...
<div class="container py-4">
        <div class="card">
            <div class="card-header">
                <!-- Judul untuk card -->
                <h2 class="text-center fw-bold mb-0">Data Belum Diangkat</h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3 text-end">
                            ...
                            <button type="button" class="btn btn-outline-primary" onclick="window.open('../report/printPDF.php', '_blank')">Print PDF</button>
                        </div>
                        ...
                        <tbody>
                            ...
                            while ($kriteria = $data->fetch_assoc()) { 
                                if ($kriteria['katagori'] == "belum diangkat") {?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="katagoriDelete.php?id=<?= $kriteria['id']; ?>" class="btn btn-outline-danger" onclick=" return confirm('Delete this data ?')">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="katagoriEdit.php" method="post">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" id="katagori" name="katagori" required>
                                                                ...
                                                                <option value="proses broadcast" <?= $kriteria['katagori'] == 'proses broadcast' ? 'disabled' : '' ?>>Proses Broadcast</option>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php
                ...
                <form action="katagoriAdd.php" method="post">
                    <div class="mb-3">
                        <label for="kode" class="form-label">Group</label>
                    ...
                    <div class="mb-3">
                        <label for="katagori" class="form-label">Katagori</label>
                        <select class="form-control" id="katagori" name="katagori" required>
                            <option value="belum diangkat" selected>Belum Diangkat</option>
                            <option value="proses broadcast" disabled>Proses Broadcast</option>
